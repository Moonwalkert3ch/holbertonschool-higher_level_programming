...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        param arg1: rect_1(Rectangle) - first rectangle
        arg2(Rectangle) - second rectangle
        raises Exceptions:
        TypeError if is not an instance of Rectangle
        """
    ...
    def square(cls, size=0):
        ...
        Arg: size(int) - the width and height
        """
